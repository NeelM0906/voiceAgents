...
const envSchema = z.object({
  ...
  OWNER_NOTIFY_ENABLED: booleanEnvSchema,
  REVIEW_REQUESTS_ENABLED: booleanEnvSchema,
  CALL_SUMMARY_MODEL: nonEmptyString.default('gpt-4o-mini'),
  CALL_SUMMARY_ENABLED: booleanEnvSchema,
  CRM_SYNC_ENABLED: booleanEnvSchema,
  GHL_API_BASE_URL: nonEmptyString.url().default('https://services.leadconnectorhq.com'),
  CRM_CREDENTIAL_KEY: optionalString,
